...
function recommendations() {
	...
	var tableDef = "<tr><th>Rating</th><th></th><th>Title</th><th>Description</th><th>Director</th><th>Staring</th><th>Age</th></tr>";	
	
	/*	The table will have span some column - Description and Director will not span.  
		These columns will be followed by the Reviw and Year recorded in the second row 
	*/
	...
	for (var i = 0; i < genreArray.length; i++) {
		...
		tableDef += "<strong>" + genreArray[i].title + "</strong>";
		...
		//Row 2 for the non-spanne values
		tableDef += "<tr><td>";				
...
function createFilmList() {
	...
	filmObj = {
		...
		starRating:5,
		filmImage:"<img src='Images/CityLights.jpg' class='poster' class='poster' alt='City Lights'>",
		ageRating:"G"
	};
	...
	filmObj = {
		...
		starRating:4,
		filmImage:"<img src='Images/Airplane!.jpg' class='poster' class='poster' alt='Airplane'>",
		ageRating:"PG"
	};
	filmArray.push(filmObj);			
	...
	filmObj = {
		...
		starRating:3,
		filmImage:"<img src='Images/MontyPython.jpg' class='poster' class='poster' alt='Monty Python'>",
		ageRating:"PG"
	};
	filmArray.push(filmObj);				
	...
	filmObj = {
		...
		starRating:5,
		filmImage:"<img src='Images/SchindlersList.jpg' class='poster' class='poster' alt='Schindlers List'>",
		ageRating:"15"
	};		
	filmArray.push(filmObj);			
	...
	filmObj = {
		...
		starRating:4,
		filmImage:"<img src='Images/Downfall.jpg' class='poster' class='poster' alt='Downfall'>",
		ageRating:"15"
	};
	filmArray.push(filmObj);			
	...
	filmObj = {
		...
		starRating:3,
		filmImage:"<img src='Images/Braveheart.jpg' class='poster' class='poster' alt='Braveheart'>",
		ageRating:"15"
	};
	filmArray.push(filmObj);		
	...
	filmObj = {
		...
		starRating:5,
		filmImage:"<img src='Images/1917.jpg' class='poster' class='poster' alt='1917'>",
		ageRating:"13"
	};		
	filmArray.push(filmObj);	
	...
	filmObj = {
		...
		starRating:4,
		filmImage:"<img src='Images/Inception.jpg' class='poster' class='poster' alt='Inception'>",
		ageRating:"13"
	};
	filmArray.push(filmObj);		
	...
	filmObj = {
		...
		starRating:3,
		filmImage:"<img src='Images/DarkKnight.jpg' class='poster' class='poster' alt='Dark Knight'>",
		ageRating:"13"
	};
	filmArray.push(filmObj);		
	...
	filmObj = {
		...
		starRating:5,
		filmImage:"<img src='Images/ShawshankRedemption.jpg' class='poster' class='poster' alt='Shawshank Redemption'>",
		ageRating:"R"
	};		
	filmArray.push(filmObj);		
	...
	filmObj = {
		...
		filmImage:"<img src='Images/Godfather.jpg' class='poster' class='poster' alt='Godfather'>",
		ageRating:"13"
	};
	filmArray.push(filmObj);	
	...
	filmObj = {
		...
		starRating:3,
		filmImage:"<img src='Images/GodfatherII.jpg' class='poster' class='poster' alt='Godfather Part 2'>",
		ageRating:"13"
	};
	filmArray.push(filmObj);
